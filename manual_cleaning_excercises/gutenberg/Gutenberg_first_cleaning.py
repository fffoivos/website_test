...
def process_books(input_folder):
    ...
    cleaned_folder = os.path.join(input_folder, 'cleaned_books')
...
if __name__ == "__main__":
    input_folder = "/home/fivos/Desktop/glossAPI_tools/website_test/manual_cleaning_excercises/gutenberg/gutenberg_books/"
