...
os.chdir("/home/fivos/Projects/GlossAPI/clean_code/")

# Load the data
data = pd.read_csv("draw3textsValidation_draw3.csv", sep=",", engine="python")
...
data.to_csv("/home/fivos/Projects/GlossAPI/clean_code/cleandraw3.csv", index=False, quoting=1)  # quoting=1 ensures all fields are quoted
